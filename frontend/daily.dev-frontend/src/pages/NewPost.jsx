...
const NewPost = () => {
  ...
  const [squadId, setSquadId] = useState("7fbec038-7882-419e-952e-71de3742c4a6"); // ID par défaut
  ...
  const handlePost = async () => {
    try {
      ...
      formData.append("squadId", "7fbec038-7882-419e-952e-71de3742c4a6"); 
      ...
      if (response.status === 201) {
        ...
        setImage(null);
        setThumbnail(null);
        setSquadId("7fbec038-7882-419e-952e-71de3742c4a6"); 
      } else {
        console.error(
        ...
        <div className="new-post-container1">
          ...
          <main className="new-post-main">
            <div className="new-post-input-group1">
              <div className="select-squad" onClick={handleSelect}>
                <FaUserGroup className="select-squad-icon" />
                <span className="select-squad-input">Select Squad</span>
                <span
                  className={`select-squad-arrow ${showMenu ? "up" : "down"}`}
                ></span>
              </div>
              {showMenu && (
                <div className="dropdown-menu">
                  <div id="default-id" className="dropdown-item">
                    <FaUserGroup className="dropdown-item-icon" />
